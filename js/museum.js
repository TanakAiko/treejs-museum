...
var query;
function init() {
    // Skip URL parameter check and go directly to 3D scene
    query = "Art Gallery"; // Default title for the gallery
    try {
...
function createScene(){
    ...
    // Let's add the PhotoFrames using local images from art folder!
